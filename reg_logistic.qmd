...
```{r regression lineaire pour la probabilité d avoir un ia1 iaf superieur a 42}
...
summary(myreg_ia4) 
```
# impact de la baisse de fertilité sur la réforme (parmis les vaches réformées)
