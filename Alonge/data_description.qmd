...
Estimation de la proportion de vaches a plus de 10 contrôles annuels 
...
```
tableau qui ne sélectionne que les animaux qui ont plus de 10 contrôles 

```{r}
lac_corr = lac[lac$n_ctrl > 9,]
```
